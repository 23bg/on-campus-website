...
export const metadata: Metadata = {
    title: "OnCampus Help Center",
    description: "Documentation, onboarding guides, and FAQs for institutes using OnCampus.",
};
    ...
    return (
        <main className="mx-auto w-full max-w-7xl px-4 py-10 md:px-6">
            <header className="mb-8">
                ...
                <h1 className="mt-2 text-3xl font-semibold tracking-tight md:text-4xl">OnCampus Documentation</h1>

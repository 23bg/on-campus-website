...
export async function generateMetadata({ params }: ProgrammaticPageProps): Promise<Metadata> {
    ...
    return {
        title: `${formattedKeyword} in ${city} | OnCampus`,
        description: `Manage admissions, enquiries, students and fees for coaching institutes in ${city} using OnCampus.`,
        alternates: {
...
export default async function ProgrammaticSolutionPage({ params }: ProgrammaticPageProps) {
    ...
    const faqSchema = {
        ...
        mainEntity: [
            {
                "@type": "Question",
                name: `Is OnCampus suitable for ${keywordLabel.toLowerCase()} in ${cityLabel}?`,
                acceptedAnswer: {
                    "@type": "Answer",
                    text: `Yes. OnCampus is designed for Indian coaching workflows and supports enquiry capture, admission, student records, and fee collection for institutes in ${cityLabel}.`,
                },
            },
            {
                "@type": "Question",
                ...
                acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes. OnCampus gives stage-wise pipeline visibility so owners and counselors can track follow-up quality, admissions closed, and pending actions without spreadsheet dependencies.",
                },
            },
            {
                "@type": "Question",
                name: "How quickly can an institute start with OnCampus?",
                acceptedAnswer: {
                    "@type": "Answer",
        ...
        <main className="mx-auto w-full max-w-5xl px-4 py-12 md:px-6 lg:py-16">
            ...
            <header className="space-y-4">
                ...
                <p className="text-muted-foreground">
                    OnCampus helps institutes in {cityLabel} manage enquiries, admissions, student operations, and fee workflows on one practical platform built for India-first coaching businesses.
                </p>
            </header>
            ...
            <section className="mt-8 space-y-4 rounded-xl border bg-muted/20 p-6">
                ...
                <p className="text-muted-foreground">
                    If your team is evaluating {keywordLabel.toLowerCase()} options in {cityLabel}, OnCampus gives you a practical workflow that connects enquiries, admissions, students, and fees in one operating system.
                </p>
            ...
            <section className="mt-8 space-y-3 text-muted-foreground">
                ...
                <h3 className="text-lg font-medium text-foreground">Can OnCampus support both small and growing institutes?</h3>
                <p>
                ...
                <p>
                    Yes. OnCampus centralizes admissions and student workflows so teams can reduce manual dependencies and improve execution consistency.
                </p>
            </section>
        </main>
    );
